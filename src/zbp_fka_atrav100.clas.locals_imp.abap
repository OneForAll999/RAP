...
CLASS lhc_travel IMPLEMENTATION.
  ...
  METHOD earlynumbering_create.
    DATA:
      entity           TYPE STRUCTURE FOR CREATE zr_fka_atrav100,
    ...
    ELSE.
      ...
      SELECT SINGLE FROM zfka_atrav100 FIELDS MAX( travel_id ) AS travelID INTO @travel_id_max.
      "Get max travel ID from draft table
      SELECT SINGLE FROM zfka_atrav100_d FIELDS MAX( travelid ) INTO @DATA(max_travelid_draft).
  ...
  METHOD setStatusOpen.
    ...
    READ ENTITIES OF zr_fka_atrav100 IN LOCAL MODE
     ENTITY Travel
    ...
    MODIFY ENTITIES OF zr_fka_atrav100 IN LOCAL MODE
      ENTITY Travel
  ...
  METHOD deductDiscount.
    ...
    DATA travels_for_update TYPE TABLE FOR UPDATE zr_fka_atrav100.
  ...
  METHOD copyTravel.
    DATA: travels TYPE TABLE FOR CREATE zr_fka_atrav100.
  ...
  METHOD acceptTravel.
    MODIFY ENTITIES OF zr_fka_atrav100 IN LOCAL MODE ENTITY Travel
    UPDATE FIELDS ( OverallStatus )
