CLASS zcl_rap100_fk_gdv2 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
*    DELETE FROM zrap100_dtrav###.
    ...
    COMMIT WORK.
    out->write( |[RAP100] Demo data generated for table zfka_atrav100{ group_id }. | ).
  ENDMETHOD.
ENDCLASS.
