CLASS zr_fka_eml100 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zr_fka_eml100 IMPLEMENTATION.
...
*        FIELDS ( AgencyID CustomerID BeginDate Description )
  ...
  METHOD update_travel.
    ...
    MODIFY ENTITIES OF zr_fka_atrav100
      ENTITY Travel
